...
This objective of this project is use KVM to demystify virtualization concepts such as virtual machine, virtual CPU and so on.

The project is composed of 3 labs with different goals:
